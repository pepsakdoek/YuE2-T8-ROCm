# Adapted from YuE2 skill scripts/abc_tools.py, commit 92a73cc7652fcc1f937855e4b765e0a0edd7ff2e.
# Copyright (c) 2026 the YuE2 authors. Apache-2.0; see official_skills/yue2-music/LICENSE.
# T8 changes: removed file/CLI entry points; parsing and invariants are unchanged.
#!/usr/bin/env python3
